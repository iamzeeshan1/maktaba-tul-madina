                ...
                <div class="table-responsive mb-4 mt-4">
                    <table class="table table-striped table-bordered text-nowrap dataTable no-footer dtr-inline">
                        ...
                        <tbody>
                            ...
                            <?php
                                $srNo = 1;
                                $query = fetch_data($link, "SELECT invt_purchase.*,invt_products.product_name, invt_suppliers.supplier_name  FROM invt_purchase LEFT  JOIN invt_suppliers ON invt_purchase.supplier_id = invt_suppliers.supplier_id LEFT  JOIN invt_products ON invt_purchase.item_id = invt_products.item_id ");
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item" href="invoice.php?id=<?=$purchase_id?>">
                                                    <i class=" bx bx-edit"> Invoice </i></a>
                                            </li>
                                            <li><a href="#" class="dropdown-item"
                                                    onclick=" JSconfirm('delete.php?purchase_id=<?= $purchase_id ?>&action=delete_item','warning','Are you sure you want to delete this purchase?')">
