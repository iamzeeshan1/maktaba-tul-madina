            ...
            <div class="table-responsive mb-4 mt-4">
              <table class="table table-bordered caption-top W-100 dataTables_length" id="prodTable">
                ...
                <tbody>
                  ...
                  <?php
                  $srNo = 1;
                  $query = fetch_data($link, "SELECT p.item_id,p.product_id,p.cost_price,p.retail_price,p.details,p.discount,p.quantity,invt_sections.section_name,invt_locations.location_name,invt_racks.rack_name,invt_categorys.category_name FROM invt_products p LEFT JOIN invt_sections ON p.section_id=invt_sections.section_id LEFT JOIN invt_locations ON p.location_id=invt_locations.location_id LEFT JOIN invt_racks ON p.rack_id=invt_racks.rack_id LEFT JOIN invt_categorys ON p.category_id=invt_categorys.category_id");
